...
/*     function init() {
        ...
        s.addShape(new Shape(containerOuter + 40, containerOuter * 2 - 30, -.6, -.4, 20, "#0095DD"));
        s.addShape(new Shape(containerOuter * 1.5, containerOuter * 2 - 100, -.9, -.6, 30, "#DD9500"));
        s.addShape(new Shape(containerOuter + 100, containerOuter * 2 - 600, .75, .9, 15, "#00DD95"));
        s.addShape(new Shape(containerOuter, containerOuter * 2 / 5, .8, .9, 40, "#DD0095"));
    }
